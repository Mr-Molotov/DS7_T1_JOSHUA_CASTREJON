...
// 9. Función para encontrar el producto con mayor valor total en inventario
...
// 10. Mostrar producto con mayor valor
$resultado = productoMayorValor($inventario);
echo "\nProducto con mayor valor en inventario: {$resultado['producto']} (Valor: \${$resultado['valor']})\n";
